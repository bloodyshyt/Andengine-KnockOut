...
/**
 * This class is the serialiable game state object that will form the nodes 
 * of search trees in all AIBot implementations
 * as of now it only supports 2 player modes. Logic to for up to 4 players will 
 * be added later when all the other bugs like memory leaks are fixed
 * 
