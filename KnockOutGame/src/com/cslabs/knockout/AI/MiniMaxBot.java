...
public class MiniMaxBot extends AbstractAIBot {
	...
	@Override
	public Shot findBestShot(GameState state, PlayerNo currentPlayer, int pDepth, int pAccuracy) {
		...
		// perturb shot 
		// TODO migrate perturbShot code to shot class itself
		Utils.perturbShot(best, pAccuracy);
		return best;
	}
