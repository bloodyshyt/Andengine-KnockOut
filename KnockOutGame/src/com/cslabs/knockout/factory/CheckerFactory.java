...
public class CheckerFactory {
	...
	public VirtualChecker cloneCheckerIntoPhyiscsWorld(FixedStepPhysicsWorld world,
			Checker p) {
		Body body = p.getBody();
